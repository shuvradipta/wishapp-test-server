...
var jwtCheck = jwt({
  secret: jwks.expressJwtSecret({
      ...
      jwksUri: "https://capitalonefinancialplanner.auth0.com/.well-known/jwks.json"
  }),
  audience: 'http://localhost:3000/api/deals/private',
  issuer: "https://capitalonefinancialplanner.auth0.com/",
  algorithms: ['RS256']
});
